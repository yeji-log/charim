...
import type { InkPoint, InkStroke } from '../lib/presentation'

/** 무지개 7색 — 색을 고르는 툴바(SlidePresenter)와 여기 렌더링이 같은
...
/**
 * 슬라이드 위에 얹는 투명한 펜/지우개 오버레이.
 *
 * CHICODE 에서 그대로 가져왔다 — 아이패드 콜아웃 방지, 좌표 정규화, 커밋
 * 전 획을 캔버스에 직접 그리는 처리까지 실기기에서 다듬어진 코드다.
 * 지우기 전에 주석을 읽을 것.
 * 파워포인트 발표 펜처럼
